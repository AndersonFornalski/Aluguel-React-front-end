...
export function RentalDetailInfo(props){
    ...
    return(
        ...
        <div className='rental-room-info'>
          <span><i className='fa-building'></i>{rental.bedrooms} bedrooms</span>
          <span><i className='fa-user'></i> {rental.bedrooms + 4} guests</span>
          <span><i className='fa-bed'></i> {rental.bedrooms + 2} beds</span>
        </div>
